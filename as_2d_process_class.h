...
public:
    AS_2D_process_class(int masksize, double sf, double sc); // Adjust constructor as needed
    ~AS_2D_process_class();
    ...
    void processData(const QVector<QVector<double>>& C_scan_AS);
